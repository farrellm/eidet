...
- **Ports: web 5175, server 8083, deployed 8091.** 5173/5174/5176 and
  8080–8082/8090 belong to other projects on this machine. Vite proxies `/api`
  → 8083.
...
no monospace, no `→` in button text. Ramp steps must clear 3:1 on the ground.
